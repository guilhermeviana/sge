 ...
 * @property int $LANCA_COMISSAO_RECEBIDA_FINANCEIRO
 * @property int $CONTA_DESTINO_COMISSAO_RECEBIDA
 * @property int $FILIAL_DESTINO_COMISSAO_RECEBIDA
 * @property int $CENTRO_CUSTOS_DESTINO_COMISSAO_RECEBIDA
 * @property string $CORRENTISTA
 * @property string $EMAIL
 * @property double $COMISSAO
 * @property int $TIPO_COMISSAO
 * @property int $DIA_FECHAMENTO_COMISSAO
 * @property int $MES_BASE_FECHAMENTO_COMISSAO
...
class Captador extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['AGENCIADOR', 'INATIVO', 'PESSOA', 'ENDERECO_CORRESPONDENCIA', 'SITUACAO_CONTATO', 'SITUACAO_CONTATO_2', 'SITUACAO_CONTATO_3', 'FORMAPAG', 'TIPOVENC', 'DIAVENC', 'TIPO_CONTA', 'BANCO', 'LANCA_COMISSAO_RECEBIDA_FINANCEIRO', 'CONTA_DESTINO_COMISSAO_RECEBIDA', 'FILIAL_DESTINO_COMISSAO_RECEBIDA', 'CENTRO_CUSTOS_DESTINO_COMISSAO_RECEBIDA', 'TIPO_COMISSAO', 'DIA_FECHAMENTO_COMISSAO', 'MES_BASE_FECHAMENTO_COMISSAO', 'ACESSA_WEB', 'EXCLUIDO', 'TIPOEND'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'AGENCIA' => 'Agencia',
            'CONTA' => 'Conta',
            'LANCA_COMISSAO_RECEBIDA_FINANCEIRO' => 'Lanca  Comissao  Recebida  Financeiro',
            'CONTA_DESTINO_COMISSAO_RECEBIDA' => 'Conta  Destino  Comissao  Recebida',
            'FILIAL_DESTINO_COMISSAO_RECEBIDA' => 'Filial  Destino  Comissao  Recebida',
            'CENTRO_CUSTOS_DESTINO_COMISSAO_RECEBIDA' => 'Centro  Custos  Destino  Comissao  Recebida',
            'CORRENTISTA' => 'Correntista',
            'EMAIL' => 'Email',
            'COMISSAO' => 'Comissao',
            'TIPO_COMISSAO' => 'Tipo  Comissao',
            'DIA_FECHAMENTO_COMISSAO' => 'Dia  Fechamento  Comissao',
            'MES_BASE_FECHAMENTO_COMISSAO' => 'Mes  Base  Fechamento  Comissao',
